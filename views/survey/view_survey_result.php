...
if(!empty($_GET['class_id'])){
   ...
   $semester=$_GET['semester'];
     ...
     $S_teacher_id=$_GET['teacher_id'];
     $login_teacher_id=$_SESSION['teacher']['id'];
    $get_result="SELECT total_points, students.name, tests.name AS test_name FROM test_result INNER JOIN tests ON test_result.test_id=tests.id JOIN students ON students.id=test_result.user_id INNER JOIN assign_test ON assign_test.test_id=test_result.test_id  INNER JOIN teachers ON teachers.id=assign_test.teacher_id WHERE students.class_id='$class_id' AND tests.id='$test_id' AND students.semester='$semester' AND  assign_test.teacher_id='$login_teacher_id' AND test_result.teacher_id='$S_teacher_id'";
?>
<br><br><br>
<div class="wrapper">
    <div class="container">
