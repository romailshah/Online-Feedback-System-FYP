...
module.exports = function(Chart) {
	// Global Chart canvas fun object for drawing items to canvas
...
module.exports = function(Chart) {
	// Global Chart fun object for utility methods and classes
	var helpers = Chart.helpers = {};
	...
	/**
	 * Provided for backward compatibility, use Chart.fun#callback instead.
	 * @function Chart.fun#callCallback
	 * @deprecated since version 2.6.0
	 * @todo remove at version 3
	 */
